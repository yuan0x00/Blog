import{_ as s,c as a,o as e,aj as p}from"./chunks/framework.BiF827kf.js";const u=JSON.parse('{"title":"今日学习","description":"","frontmatter":{},"headers":[],"relativePath":"log/day-1.md","filePath":"log/day-1.md","lastUpdated":1760200632000}'),l={name:"log/day-1.md"};function i(r,n,t,c,b,o){return e(),a("div",null,[...n[0]||(n[0]=[p(`<h1 id="今日学习" tabindex="-1">今日学习 <a class="header-anchor" href="#今日学习" aria-label="Permalink to “今日学习”">​</a></h1><ul><li>[x] Okhttp原理</li><li>核心是拦截器链。分为两类即应用拦截器和网络拦截器，应用拦截器只加在开始请求前或得到响应后。网络拦截器可以加到内置连接器中间。</li></ul><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>[Application Interceptor 1]</span></span>
